...
python stage3_jtd/build_joint_transfer_domain.py \
  --stage2-root /data/dendritron-stage2 \
...
def input_contract(
    *,
    ...
    if not bool(stage2_manifest.get("completed")):
        raise ValueError("Stage-2 donor manifest is incomplete")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--stage2-root",
        type=Path,
        default=Path("/data/dendritron-stage2"),
    )
    parser.add_argument(
        "--dictionary",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("/data/dendritron-stage4-jtd"),
    )
    parser.add_argument(
        "--cache-dir",
        type=Path,
