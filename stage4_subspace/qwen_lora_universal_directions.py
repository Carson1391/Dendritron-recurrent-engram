...
Example, WSL:
  python qwen_lora_universal_directions.py \
    --adapters_dir /path/to/qwen_loras \
    --out_dir /path/to/dendritron/qwen_universal_lora_dirs \
...
Example, PowerShell:
  python qwen_lora_universal_directions.py `
    --adapters_dir "C:\path\to\qwen_loras" `
    --out_dir "C:\path\to\dendritron\qwen_universal_lora_dirs" `
    --modules q_proj,k_proj,v_proj `
    --layers all `
    --ranks 8,16,32,64,128,256,512 `
    --center task `
