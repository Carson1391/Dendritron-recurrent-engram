"""Causal HarMax derivative contraction without Q/K/V or softmax."""
...
class HarMaxContraction(nn.Module):
    ...
    Pool mass comes from ordinary Euclidean distance.  Target mass comes from
    positive evidence strengths.  Their difference
    ``target_mass - distance_mass`` creates attraction and repulsion directly.
    The latent geometry contains no learned pairwise metric.
    """
