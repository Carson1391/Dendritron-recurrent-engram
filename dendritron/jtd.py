    ...
    *,
    ...
    try:
        ...
        for source in records:
            ...
            _progress_total += 1
            if _progress_total % 100_000 == 0:
                print(
                    f"[jtd] progress: {_progress_total:,} records — "
                    f"bigrams={counts['bigrams']:,} trigrams={counts['trigrams']:,} "
                    f"dict={counts['dictionary']:,} addresses={address_rows:,}",
                    flush=True,
                )
